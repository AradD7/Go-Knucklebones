...
The backend for [Silly Mini Games](https://www.sillyminigames.com), built with Go and featuring real-time gameplay via WebSockets, Google OAuth authentication, and AI opponents. Silly Mini Games is planned as a game hub to play fun, simple, and lesser-known mini games with your friends! Currently only the game of Knucklebones is available, but more games are coming.
## Motivation
