...
The backend for [Silly Mini Games](https://www.sillyminigames.com), built with Go. Features real-time multiplayer via WebSockets, Google OAuth authentication, and AI opponents. Currently supports Knucklebones, with more 2-player games planned.
## Motivation
